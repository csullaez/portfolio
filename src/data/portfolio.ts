...
export const personalInfo: PersonalInfo = {
  ...
  socialLinks: [
    ...
    {
      platform: "LinkedIn",
      url: "https://www.linkedin.com/in/carlos-sullaez-butron/",
      icon: "linkedin",
    },
  ],
};
...
export const projects: Project[] = [
  {
    ...
    title: "DriveTest",
    description:
      "Plataforma para análisis de calidad de servicio de empresas telefónicas en Bolivia con más de 20,000 radiobases.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Sistema de información normativa con OCR y procesamiento de lenguaje natural.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Sistema de gestión documental con motor de trámites y formularios dinámicos.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Sistema de gestión de derechos reales con formularios dinámicos.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Sistema de gestión de beneficios con interoperabilidad gubernamental.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Dashboard interactivo para gestión de permisos, horarios y bitácoras.",
    longDescription:
  ...
  },
  {
    ...
    title: "AppDigitales",
    description:
      "Aplicación de control de rutas de transporte con procesamiento asíncrono.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Sistema de registro comercial con gaceta y búsqueda de empresas.",
    longDescription:
...
export const experience: Experience[] = [
  {
    ...
    company:
      "ATT - Autoridad de Regulación y Fiscalización de Telecomunicaciones",
...
export const teaching: Experience[] = [
  {
    ...
    location: "La Paz, Bolivia",
    achievements: ["Docente de Criptografía y Seguridad", "Docente de Redes I"],
    technologies: [],
  },
  {
    id: "2",
  ...
  },
  {
    ...
    location: "La Paz, Bolivia",
    achievements: ["Auxiliar de Especificaciones Formales y Verificación"],
    technologies: [],
  },
  {
    id: "5",
