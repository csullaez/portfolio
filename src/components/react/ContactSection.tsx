      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-8">
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-6">Gracias por contactarme. Te responderé lo antes posible.</p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-8">
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6">Información de contacto</h3>
              
              <div className="space-y-4">
                <a 
                  href={`mailto:${email}`}
                  className="flex items-center gap-4 p-4 bg-white dark:bg-slate-700 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors group"
                >
                ...
                {phone && (
                  <a 
                    ...
                    className="flex items-center gap-4 p-4 bg-white dark:bg-slate-700 rounded-xl hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors group"
                  >
                ...
                <div className="flex items-center gap-4 p-4 bg-white dark:bg-slate-700 rounded-xl">
                ...
                {cvUrl && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 p-4 bg-white dark:bg-slate-700 rounded-xl hover:bg-amber-50 dark:hover:bg-amber-900/30 transition-colors group"
                  >
                    ...
                    <div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Currículum</p>
                      <p className="font-medium text-slate-900 dark:text-white">Descargar CV</p>
                    </div>
                  </a>
                )}
              </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-8">
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-6">Sígueme</h3>
              <div className="flex gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-14 h-14 bg-white dark:bg-slate-700 rounded-xl flex items-center justify-center hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-all duration-200 hover:scale-110 group"
                    aria-label={link.platform}
                  >
                    {link.icon === 'github' && (
                      <svg className="w-6 h-6 text-slate-600 dark:text-slate-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400" fill="currentColor" viewBox="0 0 24 24">
